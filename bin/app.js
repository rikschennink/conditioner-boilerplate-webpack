...
/***/ function(module, exports, __webpack_require__) {
	...
	var conditioner = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (win, undefined) {
	    ...
	    // AMD
	        ...
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, __webpack_require__(2), __webpack_require__(3), __webpack_require__(4), __webpack_require__(5), __webpack_require__(6)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    }
	    // Browser globals
	    else {
	        // @ifdef DEV
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./lib/conditioner": 8,
		"./lib/conditioner.js": 8,
		"./lib/monitors/connection": 10,
		"./lib/monitors/connection.js": 10,
		"./lib/monitors/element": 12,
		"./lib/monitors/element.js": 12,
		"./lib/monitors/media": 14,
		"./lib/monitors/media.js": 14,
		"./lib/monitors/pointer": 16,
		"./lib/monitors/pointer.js": 16,
		"./lib/monitors/window": 18,
		"./lib/monitors/window.js": 18,
		"./lib/utils/Observer": 20,
		"./lib/utils/Observer.js": 20,
		"./lib/utils/Promise": 21,
		"./lib/utils/Promise.js": 21,
		"./lib/utils/contains": 22,
		"./lib/utils/contains.js": 22,
		"./lib/utils/extendClassOptions": 23,
		"./lib/utils/extendClassOptions.js": 23,
		"./lib/utils/matchesSelector": 25,
		"./lib/utils/matchesSelector.js": 25,
		"./lib/utils/mergeObjects": 26,
		"./lib/utils/mergeObjects.js": 26,
		"./ui/Clock": 27,
		"./ui/Clock.js": 27,
		"./ui/Zoom": 29,
		"./ui/Zoom.js": 29
	...
	module.exports = function(callback, errback) {
	  !/* require.ensure */(function(error) {
	    if (error) {
	      ...
	      callback(__webpack_require__(1))
	    }
	  }(__webpack_require__));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(9)
	module.exports = function(callback, errback) {
	  __webpack_require__.e/* nsure */(1, function(error) {
	    if (error) {
	      errback(error);
	    } else {
	      callback(__webpack_require__(11))
	    }
	  });
	};
	...
	module.exports = function(callback, errback) {
	  __webpack_require__.e/* nsure */(2, function(error) {
	    if (error) {
	      ...
	      callback(__webpack_require__(13))
	    }
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(9)
	module.exports = function(callback, errback) {
	  __webpack_require__.e/* nsure */(3, function(error) {
	    if (error) {
	      errback(error);
	    } else {
	      callback(__webpack_require__(15))
	    }
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(9)
	module.exports = function(callback, errback) {
	  __webpack_require__.e/* nsure */(4, function(error) {
	    if (error) {
	      errback(error);
	    } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(9)
	module.exports = function(callback, errback) {
	  __webpack_require__.e/* nsure */(5, function(error) {
	    if (error) {
	      errback(error);
	    } else {
	      callback(__webpack_require__(19))
	    }
	  });
	};
	...
	module.exports = function(callback, errback) {
	  !/* require.ensure */(function(error) {
	    if (error) {
	      ...
	      callback(__webpack_require__(3))
	    }
	  }(__webpack_require__));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(9)
	module.exports = function(callback, errback) {
	  __webpack_require__.e/* nsure */(6, function(error) {
	    if (error) {
	      errback(error);
	    } else {
	      callback(__webpack_require__(24))
	    }
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(9)
	module.exports = function(callback, errback) {
	  __webpack_require__.e/* nsure */(7, function(error) {
	    if (error) {
	      errback(error);
	    } else {
	      callback(__webpack_require__(28))
	    }
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(9)
	module.exports = function(callback, errback) {
	  __webpack_require__.e/* nsure */(8, function(error) {
	    if (error) {
	      errback(error);
	    } else {
	      callback(__webpack_require__(30))
	    }
	  });
	};
